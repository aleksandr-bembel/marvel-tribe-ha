...
### 4. Проверка
После установки должны появиться **37 сущностей**:
- 📊 **14 сенсоров** (батарея, WiFi, RGB, LCD, будильники и др.)
...
- 🔲 **5 кнопок** (синхронизация, ping, обновление и др.)
- 🔘 **7 двоичных сенсоров** (подключение, зарядка, статусы)
